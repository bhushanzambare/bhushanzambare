...
class Father extends Grandfather {
	...
	void myCar() {
		System.out.println("I am class of Father");
	}
...
//creating an object or instance of child most class and reffered by its parent
		Father f1 = c1;// Father f2=new child1(21);home,car but bike will not be visible/accessible to
						// father
		f1.myHome();
		f1.myCar();
		System.out.println("**************************************************");
//creating an object or instance of child most class and reffered by its parent 
		Grandfather g1 = c1;// Grandfather g2 =new Child1(20);home but car & bike will not be visible
							// /accessible to Grandfather
		g1.myHome();
		System.out.println("**********************************************************");
//creating an object or instance of child most class and reffered by its parent
