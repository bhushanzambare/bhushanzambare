...
//Interface declaration: by default user
interface Drawable {
	int salary = 25000; // by default--->public static final in salary=25000;

	void draw();// bu default----->public abstract void draw();
}
...
class Interface1 {
	public static void main(String[] args) {
		...
		c1.draw();// drawing circle//In real scenario,object is provided by
					// methode.g.getDrawable()
