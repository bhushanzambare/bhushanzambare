...
public class StringClass1 {
	...
	public static void main(String[] args) {
		...
		String s2 = "Mumbai";// no object will be create as its a duplicate object,so's2'will points
								// to's1'object
		...
		/*
		 * Outside String class: == ----->compare two values .equals(obj) --->compare
		 * two objects based on there address Inside String class: == --->compare two
		 * objects based on address .equals(obj) ---> compare two objects based value
		 */
		System.out.println("s1 & s2 using equals():" + s1.equals(s2));// compare s1 and s2 values
		System.out.println("s1 & s2 using '==':  " + (s1 == s2));// compare s1 and s2 based on address
		System.out.println("s1 & s3 using equals(): " + s1.equals(s3));// compare s1 and s3 values
		System.out.println("s1 & s3 '==' :  " + (s1 == s3));// compare s1 and s3 based on address
		...
		System.out.println("s1 & s4 using '==' : " + (s1 == s4));// compare s1 and s4 based on address---->false
		...
		System.out.println("s4 & s5 using '==': " + (s4 == s5));// compare s5 and s4 based on address-->false
