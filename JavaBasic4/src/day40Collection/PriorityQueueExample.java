...
public class PriorityQueueExample {
	...
	public static void main(String[] args) {
		...
		System.out.println("Elemente of Queue: " + queue);
		// elements() returns top most element of the queue,if the queue if empty dn it
		// will throw an exception by name'NoSuchElementException'
		System.out.println("head element of the quque: " + queue.element());
		...
		System.out.println("iterating the quque elements using Iterator:");
		...
		// it will remove top most element of the Queue,If the queueis empty dn it
