...
public class ListExample extends Object {
	...
	public static void main(String[] args) {
		...
		// int will be boxed (wrapper class) to Integer class object and dn that object
		// will be upcasted to Object class object
		a1.add(123);
		/*
		 * java complier will perform below action at compile time Integer intobj=new
		 * Integer(123);//boxing operation to get Integer class object Object
		 * obj4=intobj;// auto-upcasting Integer class object to Object class object
		 */
