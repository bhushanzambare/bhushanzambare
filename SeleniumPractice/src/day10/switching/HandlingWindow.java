...
public class HandlingWindow {
	...
	public static void main(String[] args) {
		...
		System.out.println("After removing homeWinId, all window ID: " + allWinIds);
		...
		// now you are allow to identify any element from ckhild window
		...
		// driver.close();
		// driver.quite();//comment below code
