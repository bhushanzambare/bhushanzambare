...
public class CricinfoMenuSubMenu {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		List<WebElement> mainMenu = driver
				.findElements(By.cssSelector(".ds-bg-fill-navbar .ds-flex-row>div.ds-popper-wrapper>a"));
		for (int i = 0; i < mainMenu.size(); i++) {
			...
			List<WebElement> subMenu = driver
					.findElements(By.xpath("//ul[contains(@class,'ds-overflow-ellipsis')]/li/a/span"));
			if (subMenu.size() > 0) {
